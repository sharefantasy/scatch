...
packer.startup(function(use)
    ...
    use { 'jacoborus/tender.vim', config = function()
    ...
    use { "windwp/nvim-autopairs", config = function() require("nvim-autopairs").setup {
    ...
    use { "danymat/neogen", ft = DEV_LANG, config = function()
    ...
    use { 'jose-elias-alvarez/null-ls.nvim', ft = DEV_LANG, config = function()
    ...
    use { 'idanarye/nvim-channelot', ft = DEV_LANG }
